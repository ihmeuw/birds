...
adamsa[!is.na(traila_numincomplete), traila_timecat := 1] ## DIDN'T COMPLETE ASSIGNING TO LOWEST CATEGORY
...
adamsa[!is.na(trailb_numincomplete), trailb_timecat := 1] ## DIDN'T COMPLETE ASSIGNING TO LOWEST CATEGORY
