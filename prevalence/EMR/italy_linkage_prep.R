...
hosp_files <- hosp_files[!grepl("^~", hosp_files)] ## FOR SOME REASON THE FIRST FILE IS A GHOST FILE OR SOMETHING
hosp_files <- hosp_files[grepl(".XLSX$", hosp_files)] ## SOMEONE ADDED A FOLDER IN THIS DIRECTORY
